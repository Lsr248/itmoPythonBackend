...
#     response = client.post(f"/api/v1/cart/remove/", json=remove_data)
...
#     response = client.post(f"/api/v1/cart/add/", json=insert_data)
#     assert response.status_code == excepted_status
...
def test_pay(insert_data, excepted_status):
    response = client.post(f"/api/v1/cart/pay/")
    assert response.status_code == excepted_status
